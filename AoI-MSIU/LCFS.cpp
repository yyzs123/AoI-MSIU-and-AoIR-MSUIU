...
int main(int argc, char *argv[])
{
    ...
    ofstream out((string("../Results/") + to_string(ns) + string("_") + to_string(cs) + "_" + to_string(cacnt) + "_" + to_string(alpha) + "_LCFS.txt").c_str(), ios::out);
    if(!out.is_open()){
